LANGUAGE_NAME := tree-sitter-c3
HOMEPAGE_URL := https://github.com/c3lang/tree-sitter-c3
VERSION := 0.8.2
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/c3 '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/c3
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/c3
